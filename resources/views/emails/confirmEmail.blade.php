@php
    ...
    $numbers = str_split($validate_email_code);
@endphp
<x-body>
    <x-slot:content>
        <style>
                ...
                <table class="content-table" width="536" align="center" cellspacing="0" cellpadding="0" bgcolor="0029FF" style="padding: 15px;">
                    ...
                    <tr>
                        <td style="padding-top: 35px; padding-left: 35px;">
                            ...
                            <div class="main-text">для подтверждения</div>
                            <div class="main-text">e-mail после</div>
                            <div class="main-text">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td width="230">регистрации</td>
                                            <td width="230" class="white-round">
                                            <div>
